        ...
        var markup = "<tr>" + 
                    ...
                    "<td>" +
                        "<div id='image-dropdown_" + key + "' class='image-dropdown'  onmouseleave='hideee(\"" + key + "\");'>" +
                            ...
                            "<div class='img_holder' onclick='selectIcon(this, \"" + key + "\", \"\");' onmouseover='showIcon(\"" + key + "\");'>" +
                                "<span class='iTEXT'>Select Image</span>" +
                            "</div>" +                       
                            "<div class='img_holder' onclick='selectIcon(this, \"" + key + "\", \"/img/bee.png\");' onmouseover='showIcon(\"" + key + "\");'>" +
                                "<img class='flagimgs first' src='/img/bee.png' height=30 width=30 /> <span class='iTEXT'>Bee</span>" +
                            "</div>" +
                            "<div class='img_holder' onclick='selectIcon(this, \"" + key + "\", \"/img/doubleswoosh.png\");' onmouseover='showIcon(\"" + key + "\");'>" +
                                "<img class='flagimgs first' src='img/doubleswoosh.png' height=30 width=30 /> <span class='iTEXT'>doubleswoosh</span>" +
                            "</div>" +
                            "<div class='img_holder' onclick='selectIcon(this, \"" + key + "\", \"/img/fire.png\");' onmouseover='showIcon(\"" + key + "\");'>" +
                                "<img class='flagimgs first' src='img/fire.png' height=30 width=30  /> <span class='iTEXT'>fire</span>" +
                            "</div>" +
                            "<div class='img_holder' onclick='selectIcon(this, \"" + key + "\", \"/img/githubicon.png\");' onmouseover='showIcon(\"" + key + "\");'>" +
                                "<img class='flagimgs first' src='img/githubicon.png'  height=30 width=30  /> <span class='iTEXT'>Githubicon</span>" +
                            "</div>" +
                            "<div class='img_holder' onclick='selectIcon(this,\"" + key + "\", \"/img/gradhat.png\");' onmouseover='showIcon(\"" + key + "\");'>" +
                                "<img class='flagimgs first' src='img/gradhat.png' height=30 width=30 /> <span class='iTEXT'>Gradhat</span>" +
                            "</div>" +
                            "<div class='img_holder' onclick='selectIcon(this, \"" + key + "\", \"/img/greenshield.jpg\");' onmouseover='showIcon(\"" + key + "\");'>" +
...
function setSelectedStyle(selectedNodes, bold, size, name, fontColor){
    var that = this;
...
function selectIcon(imgParent, key, image) {
  hideee(key);
